...
const cards = [
    new CardProgramming("104", "Sacred Spear", "WHITE", [
        new Rule(
            ...
            "ENEMY_FIELD",
            "NOT_APPLY",
            ["CARD_OF_COLOR_BLACK", "CARD_OF_COLOR_BLUE", "CARD_OF_COLOR_RED", "CARD_OF_COLOR_GREEN"],
            ["DIGIMON"],
            "ALL",
            null
        )
    ...
    new CardProgramming("105", "Tidal Wave", "BLUE", [
        new Rule(
            ...
            "ENEMY_FIELD",
            "NOT_APPLY",
            ["CARD_OF_COLOR_BLACK", "CARD_OF_COLOR_WHITE", "CARD_OF_COLOR_RED", "CARD_OF_COLOR_GREEN"],
            ["DIGIMON"],
            "ALL",
            null
        )
    ...
    new CardProgramming("110", "Volcanic Gatlin", "RED", [
        new Rule(
            ...
            "ENEMY_FIELD",
            "NOT_APPLY",
            ["CARD_OF_COLOR_BLACK", "CARD_OF_COLOR_WHITE", "CARD_OF_COLOR_BLUE", "CARD_OF_COLOR_GREEN"],
            ["DIGIMON"],
            "ALL",
            60
        )
    ...
    new CardProgramming("113", "Darkness Gale", "BLACK", [
        new Rule(
            ...
            "ENEMY_FIELD",
            "NOT_APPLY",
            ["CARD_OF_COLOR_WHITE", "CARD_OF_COLOR_BLUE", "CARD_OF_COLOR_GREEN", "CARD_OF_COLOR_RED"],
            ["DIGIMON"],
            "ALL",
            null
        )
